...
public abstract class DetermineDesiredStateAchievingActionsStepBaseTest extends SyncFlowableStepTest<DetermineDesiredStateAchievingActionsStep> {
    ...
    protected final ApplicationStartupState currentAppState;
    protected final ApplicationStartupState desiredAppState;
    protected final boolean hasAppChanged;
    protected final Set<ApplicationStateAction> expectedAppStateActions;
    protected final List<CloudBuild> cloudBuilds;
