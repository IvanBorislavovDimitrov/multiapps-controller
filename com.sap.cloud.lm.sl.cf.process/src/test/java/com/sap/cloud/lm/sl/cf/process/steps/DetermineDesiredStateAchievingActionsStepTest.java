    ...
    public static class DetermineAppRestartTest extends DetermineDesiredStateAchievingActionsStepBaseTest {
        ...
        public static List<Object[]> getParameters() throws ParseException {
            return Arrays.asList(new Object[][] {
                ...
                // (4)
                {
                    STARTED_APPLICATION_STARTUP_STATE, STARTED_APPLICATION_STARTUP_STATE, Stream.of(ApplicationStateAction.STAGE).collect(Collectors.toSet()), Collections.emptyList(), false, false, false, false, false, false
                },
                // (5)
                {
                    STARTED_APPLICATION_STARTUP_STATE, STARTED_APPLICATION_STARTUP_STATE, Stream.of(ApplicationStateAction.STAGE).collect(Collectors.toSet()), Collections.emptyList(), true, false, false, false, false, false
                },
                // (6)
                {
                    STARTED_APPLICATION_STARTUP_STATE, STARTED_APPLICATION_STARTUP_STATE, Stream.of(ApplicationStateAction.STAGE).collect(Collectors.toSet()), Collections.emptyList(), false, true, false, false, false, false
                },
                // (7)
                {
                    STARTED_APPLICATION_STARTUP_STATE, STARTED_APPLICATION_STARTUP_STATE, Stream.of(ApplicationStateAction.STAGE).collect(Collectors.toSet()), Collections.emptyList(), false, false, true, false, false, false
                },
                // (8)
                {
                    STARTED_APPLICATION_STARTUP_STATE, STARTED_APPLICATION_STARTUP_STATE, Stream.of(ApplicationStateAction.STAGE).collect(Collectors.toSet()), Collections.emptyList(), false, false, false, true, false, false
                },
                // (9)
                {
                    STARTED_APPLICATION_STARTUP_STATE, STARTED_APPLICATION_STARTUP_STATE, Stream.of(ApplicationStateAction.STAGE).collect(Collectors.toSet()), Collections.emptyList(), false, false, false, false, true, false
                },
                // (10)
                {
                    STARTED_APPLICATION_STARTUP_STATE, STARTED_APPLICATION_STARTUP_STATE, Stream.of(ApplicationStateAction.STAGE).collect(Collectors.toSet()), Collections.emptyList(), false, false, false, false, false, true
                },
            });
        }
